...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action,
        ...
        final Intent intent = new Intent(action);
        Log.d("broadcast","update : " + characteristic.getUuid());
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            final int battery = characteristic.getIntValue(format, 1);
            Log.i("Battery", "Level : "+String.valueOf(battery));
            intent.putExtra(EXTRA_DATA, String.valueOf(battery));
        } else {
